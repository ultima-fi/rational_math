...
module Ultima::u256 {
  ...
  public fun gt(a: &U256, b: &U256): bool {
    return compare(a, b) == GREATER_THAN
  }

  public fun lte(a: &U256, b: &U256): bool {
    return (compare(a, b) == LESS_THAN || compare(a, b) == EQUAL)
  }

  public fun gte(a: &U256, b: &U256): bool {
    return (compare(a, b) == GREATER_THAN || compare(a, b) == EQUAL)
  }
